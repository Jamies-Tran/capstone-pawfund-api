...
public class PetIntakeRegistrationPathV1Controller implements IPetIntakeRegistrationPathV1API {
    @NonNull
    ...
    @Override
    public ValueResponse<PetIntakeRegistrationResponse> processPetIntakeRegistration(Long petIntakeRegistrationId) {
    ...
    @Override
    public ValueResponse<PetIntakeRegistrationResponse> cancelPetIntakeRegistration(
