...
public class VerificationCodeV1PubController implements IVerificationCodeV1PubAPI {
    ...
    @Override
    public ValueResponse<VerificationCodeResponse> sendAccountVerification(String email) {
        VerificationCode verificationCode = useCase.createAndSendCodeVerificationAccount(VerificationMail.of(email));
